...
public class FTBaseTest {
    ...
    protected static final String TEST_PENDING_RUM_APP_ID = "pending_rum_app_id";
    ...
    /**
     * Get pending remote config app id in SDK
     *
     * @return
     */
    public String getPendingRemoteConfigAppId() {
        return Whitebox.getInternalState(FTSdk.get(), "pendingRemoteConfigAppId");
    }
