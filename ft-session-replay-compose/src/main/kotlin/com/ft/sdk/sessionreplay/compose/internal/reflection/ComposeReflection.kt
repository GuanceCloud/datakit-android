...
package com.ft.sdk.sessionreplay.compose.internal.reflection
...
internal object ComposeReflection {
    ...
    val BackgroundElementClass =
        getClassSafe("androidx.compose.foundation.BackgroundElement", isCritical = false)
            ?: getClassSafe("androidx.compose.foundation.Background", isCritical = false)
    val ColorField = BackgroundElementClass?.getDeclaredFieldSafe("color", isCritical = false)
    val ShapeField = BackgroundElementClass?.getDeclaredFieldSafe("shape", isCritical = false)
    ...
    val PaddingElementClass =
        getClassSafe("androidx.compose.foundation.layout.PaddingElement", isCritical = false)
            ?: getClassSafe("androidx.compose.foundation.layout.PaddingModifier", isCritical = false)
    val PaddingValuesModifierClass = getClassSafe(
        "androidx.compose.foundation.layout.PaddingValuesModifier",
        isCritical = false
    )
    val PaddingValuesField = PaddingValuesModifierClass?.getDeclaredFieldSafe(
        "paddingValues",
        isCritical = false
    )
    val PaddingValuesImplClass = getClassSafe(
        "androidx.compose.foundation.layout.PaddingValuesImpl",
        isCritical = false
    )
    val StartField = PaddingElementClass?.getDeclaredFieldSafe("start", isCritical = false)
        ?: PaddingValuesImplClass?.getDeclaredFieldSafe("start", isCritical = false)
    val EndField = PaddingElementClass?.getDeclaredFieldSafe("end", isCritical = false)
        ?: PaddingValuesImplClass?.getDeclaredFieldSafe("end", isCritical = false)
    val BottomField = PaddingElementClass?.getDeclaredFieldSafe("bottom", isCritical = false)
        ?: PaddingValuesImplClass?.getDeclaredFieldSafe("bottom", isCritical = false)
    val TopField = PaddingElementClass?.getDeclaredFieldSafe("top", isCritical = false)
        ?: PaddingValuesImplClass?.getDeclaredFieldSafe("top", isCritical = false)

    val GraphicsLayerElementClass =
        getClassSafe("androidx.compose.ui.graphics.GraphicsLayerElement", isCritical = false)
            ?: getClassSafe("androidx.compose.ui.graphics.GraphicsLayerModifierNodeElement", isCritical = false)
            ?: getClassSafe("androidx.compose.ui.graphics.SimpleGraphicsLayerModifier", isCritical = false)
    val ClipShapeField = GraphicsLayerElementClass?.getDeclaredFieldSafe("shape", isCritical = false)

    val ComposeColorClass = getClassSafe("androidx.compose.ui.graphics.Color", isCritical = false)
    val ComposeColorValueField = ComposeColorClass?.getDeclaredFieldSafe("value", isCritical = false)

    val PainterElementClass =
        getClassSafe("androidx.compose.ui.draw.PainterElement", isCritical = false)
            ?: getClassSafe("androidx.compose.ui.draw.PainterModifierNodeElement", isCritical = false)
            ?: getClassSafe("androidx.compose.ui.draw.PainterModifierNode", isCritical = false)
    val PainterField = PainterElementClass?.getDeclaredFieldSafe("painter", isCritical = false)
    val ContentScaleField = PainterElementClass?.getDeclaredFieldSafe("contentScale", isCritical = false)
    val AlignmentField = PainterElementClass?.getDeclaredFieldSafe("alignment", isCritical = false)
...
private fun logReflectionException(name: String, type: String, reason: String, e: Throwable) = Unit
