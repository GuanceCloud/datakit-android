...
import com.ft.sdk.sessionreplay.compose.internal.utils.resolveAnnotatedString
...
internal class TextFieldSemanticsNodeMapper(
    ...
    private fun resolveTextFieldShapeWireframe(
        ...
        return ShapeWireframe(
            ...
            globalBounds.height,
            null,
            color?.let { ShapeStyle(it, null, cornerRadius) },
            null
        )
    }
            ...
            TextWireframe(
                ...
                TextPosition(
                    Padding(
                        null,
                        null,
                        (EDIT_TEXT_START_PADDING * parentContext.composeDensity.density).toLong(),
                        null
                    ),
